...
<div class="message">
  This second article was originally the first in the series, if you've already read it you can <!-- skip ahead or --> read the <a href="/fun/2021/02/16/journey-to-functional-wonderland/">re-written intro article</a> instead.
</div>
